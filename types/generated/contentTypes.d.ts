...
export interface ApiDzematDzemat extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    teravih_mode: Schema.Attribute.Boolean;
    teravih_offset: Schema.Attribute.Integer;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    data_dzemat: Schema.Attribute.JSON;
    data_majlis: Schema.Attribute.JSON;
    data_muftijstvo: Schema.Attribute.JSON;
